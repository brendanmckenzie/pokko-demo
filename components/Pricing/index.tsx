    ...
    <div className="overflow-hidden">
      <section
        ...
        className={
          ...
          (bgColour === "gray" ? "gray-light-bg" : "background-shape-right")
        }
      >
        <div className="container">
          ...
          <div className="row justify-content-center">
            {items.map((item, idx) => (
              <div className="col-lg-4 col-md" key={idx}>
                <div
                  className={
                    "card text-center single-pricing-pack " +
                    (item.isFeatured ? "popular-price" : "")
                  }
                >
                  <div className="pt-4">
                    <h5>{item.license}</h5>
                  ...
                  <div className="card-body">
                    ...
                    <a
                      ...
                      className={
                        "btn mb-3 " +
                        (item.isFeatured ? "solid-btn" : "outline-btn")
                      }
                      target="_blank"
                    >
                      Purchase now
